...
// import TabContent from 'rc-tabs/lib/TabContext';
  ...
  return (
    <Box {...sectionWrapper} as="section" id="portfolio_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading {...secTitle} content="Enginering Digital Balance" />
          <Text
            {...secDescription}
            content="Year after year, Simetri crafts digital solutions that are balanced, purposeful, and enduring. 
We believe that true innovation comes from harmony between technology and human needs."
          />
        </Box>
